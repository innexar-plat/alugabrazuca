...
describe('AuthController', () => {
  ...
  describe('register', () => {
    it('should delegate to authService.register', async () => {
      const dto = { firstName: 'John', lastName: 'Doe', email: 'j@e.com', password: 'P@ss1234', confirmPassword: 'P@ss1234', acceptTerms: true };
      mockAuthService.register.mockResolvedValue({ message: 'ok', userId: 'id' });
  ...
  describe('login', () => {
    it('should delegate to authService.login and set cookie', async () => {
      ...
      expect(mockAuthService.login).toHaveBeenCalledWith(dto, '127.0.0.1', 'Mozilla/5.0');
  ...
  describe('refresh', () => {
    ...
    it('should return 401 message when no refresh token in cookie', async () => {
      ...
      expect(result).toEqual({ statusCode: 401, message: 'Refresh token not found' });
    });
  });
  ...
  describe('resetPassword', () => {
    it('should delegate to authService.resetPassword', async () => {
      const dto = { token: 'tok', password: 'New@1234', confirmPassword: 'New@1234' };
